...
module("SC.Request", {
  ...
  setup: function() {
    url = '/static/sproutcore/ajax/en/current/fixtures/file_exists.json?1322165350'; //"/static/sproutcore/en/desktop/_src/desktop.platform/english.lproj/file_exists.json" ;
...
test("Test auto-deserializing malformed JSON", function() {
  request = SC.Request.getUrl('/static/sproutcore/ajax/en/current/fixtures/malformed.json?1322165350').set('isJSON', YES);
